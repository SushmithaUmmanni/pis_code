...
class HDF5DatasetWriter:
    ...
    Attributes:
        ...
        data (Dict)
        labels (Dict)
        buffer_size (int): The value controls the size of our in-memory buffer.
        buffer (Dict): Buffer holding data with their respective labels.
        idx (int): Dataset index.

        dims (tuple): dimension or shape of the data that will be stored
        output_path (str): Path to where our output HDF5 file will be stored on disk.
        data_key (str): Name of the dataset.
        buffer_size
    ...
    def __init__(self, dims, output_path, data_key="images", buffer_size=1000):
        ...
        Args:
            dims (Tuple[int, int, int, int]): dimension or shape of the data that will be stored
            output_path (str): Path to where our output HDF5 file will be stored on disk.
            data_key (str, optional): Name of the dataset.
            buffer_size (int, optional): The value controls the size of our in-memory buffer.
        """
    ...
    def add(self, rows, labels):
        ...
        Args:
            rows (np.ndarray): Data arrays / feature vectors.
            labels (List[int]): Labels to the corresponding feature vectors.
        """
