...
class ResNet:
    ...
    def residual_module(data, K, stride, chan_dim, reduce=False,
        ...
        Arguments:
            ...
            K {int} -- number of filters that will be learned by the final CONV in the bottleneck
        ...
        Keyword Arguments:
            ...
            regression {float} -- regularization strength to all CONV layers in the residual module
                                  (default: {0.0001})
            bn_eps {[type]} -- epsilon for avoiding “division by zero” errors when normalizing
                               inputs. (default: {2e-5})
        ...
        conv3 = Conv2D(K, (1, 1), use_bias=False, kernel_regularizer=l2(regression))(act3)
