# -*- coding: utf-8 -*-
"""Implementation of GoogLeNet architecture with MXNet.
"""
import mxnet as mx
...
class MxGoogLeNet:
    ...
    """
    @staticmethod
    def conv_module(data, filter_num, filter_x_size, filter_y_size, pad=(0, 0), stride=(1, 1)):
        """Define conv layer

        Arguments:
            data {Tensor} -- input layer to the function
        ...
        conv = mx.sym.Convolution(data=data, kernel=(filter_x_size, filter_y_size),
                                  num_filter=filter_num, pad=pad, stride=stride)
    ...
    def build(classes):
        ...
        pool4 = mx.sym.Pooling(data=in4e, pool_type="max", pad=(1, 1),
                               kernel=(3, 3), stride=(2, 2))
        ...
        dropout = mx.sym.Dropout(data=pool5, p=0.4)
...
if __name__ == "__main__":
    ...
    googlenet_model = MxGoogLeNet.build(1000)
    visualization = mx.viz.plot_network(googlenet_model,
