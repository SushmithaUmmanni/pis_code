# -*- coding: utf-8 -*-
"""Implementation of VGGNet architecture with MXNet.
"""
import mxnet as mx
...
class MxVGGNet:
    ...
    def build(classes):
        ...
        conv1_2 = mx.sym.Convolution(data=bn1_1, kernel=(3, 3), pad=(1, 1),
        ...
        pool1 = mx.sym.Pooling(data=bn1_2, pool_type="max", kernel=(2, 2),
                               stride=(2, 2), name="pool1")
        do1 = mx.sym.Dropout(data=pool1, p=0.25)

        # Block #2: (CONV => RELU) * 2 => POOL
        conv2_1 = mx.sym.Convolution(data=do1, kernel=(3, 3), pad=(1, 1),
        ...
        conv2_2 = mx.sym.Convolution(data=bn2_1, kernel=(3, 3), pad=(1, 1),
        ...
        pool2 = mx.sym.Pooling(data=bn2_2, pool_type="max", kernel=(2, 2),
                               stride=(2, 2), name="pool2")
        do2 = mx.sym.Dropout(data=pool2, p=0.25)

        # Block #3: (CONV => RELU) * 3 => POOL
        conv3_1 = mx.sym.Convolution(data=do2, kernel=(3, 3), pad=(1, 1),
        ...
        conv3_2 = mx.sym.Convolution(data=bn3_1, kernel=(3, 3), pad=(1, 1),
        ...
        conv3_3 = mx.sym.Convolution(data=bn3_2, kernel=(3, 3), pad=(1, 1),
        ...
        pool3 = mx.sym.Pooling(data=bn3_3, pool_type="max", kernel=(2, 2),
                               stride=(2, 2), name="pool3")
        do3 = mx.sym.Dropout(data=pool3, p=0.25)

        # Block #4: (CONV => RELU) * 3 => POOL
        conv4_1 = mx.sym.Convolution(data=do3, kernel=(3, 3), pad=(1, 1),
        ...
        conv4_2 = mx.sym.Convolution(data=bn4_1, kernel=(3, 3), pad=(1, 1),
        ...
        conv4_3 = mx.sym.Convolution(data=bn4_2, kernel=(3, 3), pad=(1, 1),
        ...
        pool4 = mx.sym.Pooling(data=bn4_3, pool_type="max", kernel=(2, 2),
                               stride=(2, 2), name="pool3")
        do4 = mx.sym.Dropout(data=pool4, p=0.25)

        # Block #5: (CONV => RELU) * 3 => POOL
        conv5_1 = mx.sym.Convolution(data=do4, kernel=(3, 3), pad=(1, 1),
        ...
        conv5_2 = mx.sym.Convolution(data=bn5_1, kernel=(3, 3), pad=(1, 1),
        ...
        conv5_3 = mx.sym.Convolution(data=bn5_2, kernel=(3, 3), pad=(1, 1),
        ...
        pool5 = mx.sym.Pooling(data=bn5_3, pool_type="max", kernel=(2, 2),
