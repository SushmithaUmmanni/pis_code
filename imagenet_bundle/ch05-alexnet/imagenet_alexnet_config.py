"""Configuration file for ImageNet-AlexNet
"""
from os import path

# define the base path to where the ImageNet dataset devkit are stored on disk)
...
# define the path that maps the 1,000 possible WordNet IDs to the class label integers
